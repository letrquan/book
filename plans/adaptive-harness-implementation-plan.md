...
- **Date:** 2026-07-20
- **Status:** Tier A/B and Phases 0-1 verified for trusted built-in evaluation; Tier C blocked;
  Phase 2 ready but inactive; phases 3-8 inactive; phase 9 is a future gate
...
- **Phase 0 is verified only in the trusted built-in/non-adversarial scope.** This does not activate
  Phase 1 or broaden the trust boundary. Tier C remains blocked.
...
| ----- | ----------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| 0     | Verified    | [Evaluation contract and fixtures](adaptive-harness/phase-0-evaluation-contract.md)    | Improvement can be falsified with stable metrics             |
...
| [0. Evaluation contract](adaptive-harness/phase-0-evaluation-contract.md)                         | Verified    | Codex | -         | Format/lint/type/architecture gates; unit (1,775 passing), contract (29 passing), focused evaluation/ambient tests (23 passing), build, Draft 2020-12 report validation, `git diff --check`       | Verified for `harness-corpus-v1` / `phase0-contract-v1` only. Reports require real evidence and passing promotion gates; canonical path confinement rejects symlink/junction escapes; reviewer and arm identities must be distinct. Provider trials remain uncollected, and project-controlled/adversarial execution remains Tier C blocked. Phase 1 advancement is tracked separately below.                                                                                                                                |
