...
- `npm run check` passes: formatting, lint, typecheck, architecture checks, 1,060 unit tests,
...
1. Drive send finalization from the `AgentSession` snapshot and reduce React to UI projection.
