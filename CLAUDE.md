...
**Tech stack**: TypeScript (ES2022/ESM, `moduleResolution: bundler`), React 19 via Ink 7.1.1 for the TUI, tsup for building, Vitest 4 for testing, Zod 3 for config validation. Node.js 22.19+.
